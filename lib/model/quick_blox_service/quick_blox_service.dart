...
//
//     print("kaleyraUserIdddd : $kaleyraUserId");
//
...
// //       _pref!.setInt(GwcApi.getQBSession,
...
// //   //       // print(
// //   //       //     "called  ${int.parse("${_pref!.getString(GwcApi.getQBSession)}")} ${_localUserId}");
...
// //       int senderId = int.parse(chatUserId);
...
// //           senderName, message, _pref!.getInt(GwcApi.qbCurrentUserId)!));
// //     }
...
// //         ? _pref!.getInt(GwcApi.qbCurrentUserId)
// //         : _localUserId;
// //
// //     try {

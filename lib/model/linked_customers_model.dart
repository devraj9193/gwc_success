...
//
//     final linkedCustomerList = linkedCustomerListFromJson(jsonString);

import 'dart:convert';

LinkedCustomerList linkedCustomerListFromJson(String str) =>
    LinkedCustomerList.fromJson(json.decode(str));

String linkedCustomerListToJson(LinkedCustomerList data) =>
    json.encode(data.toJson());

class LinkedCustomerList {
  LinkedCustomerList({
    this.status,
    this.errorCode,
    this.key,
  ...
  factory LinkedCustomerList.fromJson(Map<String, dynamic> json) {
    ...
    return LinkedCustomerList(
      ...
      key: json["key"],
      data:
          List<LinkedList>.from(json["data"].map((x) => LinkedList.fromJson(x)))
              .toList(),
    );
  }
...
class LinkedList {
  ...
  factory LinkedList.fromJson(Map<String, dynamic> json) => LinkedList(
        id: json["id"],
        teamId: json["team_id"],

...
//                         openDialog("${message.qbMessage.body}","${message.senderName}",message.qbMessage.dateSent!);
//                       },
//                       child: Row(
//                         children: [
//                           Icon(
...
//   }
//
//   Future openDialog(String message,String userName,int time) async {
//
...
//                                             GestureDetector(
//                                               onTap: () {
//                                                 getForwardChatGroupId(data[index].id.toString(),
//                                                   "$message\n\nForward message $userName ${_buildTime(time)}",
//                                                 );
//                                                 ScaffoldMessenger.of(context).showSnackBar( SnackBar( backgroundColor: gPrimaryColor,
//                                                   content:Text("Forwarded To ${data[index].name}"),
//                                                 ));
//                                               },
//                                               child: Container(
//                                                 padding: EdgeInsets.symmetric(
...
//                                               GestureDetector(
//                                                 onTap: () {
//                                                   getForwardChatGroupId(searchResults[index].id.toString(),
//                                                     "Forward message $userName ${_buildTime(time)}\n$message",
//                                                   );
//                                                   ScaffoldMessenger.of(context).showSnackBar( SnackBar(
//                                                     backgroundColor: gPrimaryColor,
//                                                     content:Text("Forwarded To ${searchResults[index].name}"),
//                                                   ));
//                                                 },
//                                                 child: Container(
//                                                   padding: EdgeInsets.symmetric(

...
//     }
//     if (_pref != null) {
//       if (_pref?.getString(GwcApi.doctorGroupId) != null) {
//         _groupId = _pref!.getString(GwcApi.doctorGroupId);
//         joinChatRoom(_pref!.getString(GwcApi.doctorGroupId)!);
//       }
//     }
...
//         insetPadding: EdgeInsets.only(bottom: 8.h,left: 4.w,right: 4.w,top: 2.h),
...
//                                           GestureDetector(
//                                             onTap: () {
//                                               getForwardChatGroupId(message,data[index].id.toString());
//                                               ScaffoldMessenger.of(context).showSnackBar( SnackBar(
//
//                                                 backgroundColor: gPrimaryColor,
//                                                 content:Text("Forwarded To ${data[index].fname} ${data[index].lname}"),
//                                               ));
//                                               },
//                                             child: Container(
//                                               padding: EdgeInsets.symmetric(
...
//                                             GestureDetector(
//                                               onTap: () {
//                                                 getForwardChatGroupId(message,searchResults[index].id.toString());
//                                                 ScaffoldMessenger.of(context).showSnackBar( SnackBar(
//                                                     content:Text("Forwarded To ${searchResults[index].fname} ${searchResults[index].lname}"),
//                                                 ));
//                                               },
//                                               child: Container(
//                                                 padding: EdgeInsets.symmetric(
...
//           userDetail.lname!.toLowerCase().contains(text.trim().toLowerCase())) {
...
//   );
//
//   getForwardChatGroupId(String message,String userId) async {
